...
class ExchangeConfiguration:
    ...
    def get_exchange_client(self, email, credentials, connector_info={}, read_time_out_retry=False):
            ...
            while retry_count < MAX_RETRY:
                try:
                    ...
                    return account
                        ...
                        requests.exceptions.ReadTimeout, requests.exceptions.ProxyError) as ex:
                    retry_count += 1
