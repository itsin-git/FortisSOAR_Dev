...
MAX_RETRY = 5
DELAY_TIME = 5
DEFAULT_FOLDER_PATH = ['Top of Information Store', "Recoverable Items"]
...
AUTH_TYPE = {"OAUTH": "OAUTH", "NTLM/Basic Auth": "NTLM/Basic"}

OAUTH_AUTHENTICATION_MAP = {
    'On behalf of User - Delegated Permission': 'AUTH_BEHALF_OF_USER',
    'Without a User - Application Permission': 'AUTH_USING_APP'
}

OAUTH_PERMISSION_MAP = {
    'AUTH_BEHALF_OF_USER': 'On behalf of User - Delegated Permission',
    'AUTH_USING_APP': 'Without a User - Application Permission'
}

ACCESS_TYPE_MAP = {"Without a User - Application Permission": 'IMPERSONATION',
                   'On behalf of User - Delegated Permission': 'DELEGATE'}

ext_lst = ['.txt', '.csv', '.html', '.msg', '.eml', '.json', '.doc', '.docx', '.pdf', '.odt', '.rtf', '.tex', '.wps',
           '.wks', '.wpd', '.mp3', '.jpg', '.png', '.aif', '.cda', '.midi', '.mid', '.mpa', '.ogg', '.wav', '.wma',
           '.wpl', '.7z', '.arj', '.deb', '.pkg', '.rar', '.rpm', '.tar.gz', '.z', '.zip', '.bin', '.dmg', '.iso',
           '.toast', '.vcd', '.dat', '.db', '.dbf', '.log', '.mdb', '.sav', '.sql', '.tar', '.xml', '.apk', '.bat',
           '.bin', '.cgi', '.pl', '.com', '.exe', '.gadget', '.jar', '.py', '.wsf', '.fnt', '.fon', '.otf', '.ttf',
           '.ai', '.bmp', '.gif', '.ico', '.jpeg', '.ps', '.psd', '.svg', '.tif', '.tiff', '.asp', '.aspx', '.cer',
           '.cfm', '.css', '.htm', '.js', '.jsp', '.part', '.php', '.rss', '.xhtml', '.key', '.odp', '.pps', '.ppt',
           '.pptx', '.c', '.class', '.cpp', '.cs', '.h', '.java', '.sh', '.swift', '.vb', '.ods', '.xlr', '.xlsx',
           '.bak', '.cab', '.cfg', '.cpl', '.cur', '.dll', '.dmp', '.drv', '.icns', '.ico', '.ini', '.lnk', '.msi',
           '.sys', '.tmp', '.3g2', '.3gp', '.avi', '.flv', '.h264', '.m4v', '.mkv', '.mov', '.mp4', '.mpg', '.mpeg',
           '.rm', '.swf', '.vob', '.wmv']

MESSAGES = {
    'invalid_json': 'The Query input must be a valid json',
    'invalid_input': 'No Email Found With Given Message-ID/ Invalid Source/Destination Folder',
    'move_resp': 'Email moved successfully',
    'copy_resp': 'Email copied successfully',
    'attachment_iri': '{} Attachment added to email',
    'required_to_bcc_cc': 'At least one value required from To/Cc/Bcc',
    'parsing_error': 'Error in parsing attachment file {}',
    'marked_read': 'Marked Email as Read',
    'email_not_found': 'Email Not Found with message ID {}',
    'not_found': 'No Email Found With Given Message-ID',
    'moved_status': 'successfully moved email to {} folder',
    'copy_status': 'successfully copied email to {} folder',
    'delete_resp': 'Email Deleted successfully',
    'attachment_not_found': 'could not find attachment with id {}',
    'send_resp': 'Email sent successfully',
    'upload_attachment': 'Email file added in CyOPs attachment',
    'src_folder': 'Retrieving emails from {} folder',
    'fetch_category': 'Categories successfully fetched',
    'add_category': 'Categories successfully Added',
    'remove_category': 'Categories successfully Removed'
}
property_tags = {
